...
#define EP_IN 0x81
#define EP_OUT 0x01
unsigned char COMMAND_1[8] = {0x63,0x00,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_2[8] = {0x63,0x01,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_3[8] = {0x63,0x02,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_4[8] = {0x63,0x03,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_5[8] = {0x63,0x04,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_6[8] = {0x63,0x05,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_7[8] = {0x63,0x06,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_8[8] = {0x63,0x07,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_9[8] = {0x63,0x08,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_10[8] = {0x63,0x09,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_11[8] = {0x63,0x0a,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_12[8] = {0x63,0x0b,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_13[8] = {0x63,0x0c,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_14[8] = {0x63,0x0d,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_15[8] = {0x63,0x0e,0x80,0x00,0x08,0xff,0x08,0xff};
unsigned char COMMAND_16[8] = {0x63,0x0f,0x80,0x00,0x08,0xff,0x08,0xff};
int main(int argc, char * argv[])
{
  libusb_device_handle * handle;
	...
	if (argc != 2) {
		printf("Укажите номер порта который вы хотите включить (1...16)\n", argv[0]);
		return -1;
	}
	port = atoi(argv[1]);
